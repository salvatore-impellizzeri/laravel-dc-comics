...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Linee di linguaggio per la validazione
    |--------------------------------------------------------------------------
    |
    | Le seguenti linee contengono i messaggi di errore predefiniti utilizzati
    | dalla classe di validazione. Alcune di queste regole hanno più versioni
    | come le regole di dimensione. Sentiti libero di modificare questi messaggi.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Il :attribute fornito è presente in una violazione dei dati. Scegli un :attribute diverso.',
    ],
